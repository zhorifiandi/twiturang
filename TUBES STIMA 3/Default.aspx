...
<body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="#services" class="page-scroll btn btn-xl">GETTING STARTED</a>
            </div>
        </div>
    </header>
    ...
    -->
    <!-- Launch Section -->
    <section id="Launch" class =" bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
            ...
            <div class="row">
                ...
                <br />
                <div class="col-sm-offset-4 col-sm-4">
                        <h4>Keyword Departemen Kebersihan</h4>
                      <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control input-lg" placeholder="contoh: Bersih;Sampah;"></asp:TextBox>
                      <p style="margin-top:5px;">
                ...
                <br />
                <div class="col-sm-offset-4 col-sm-4">
                        <h4>Keyword Departemen Kesehatan</h4>
                      <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control input-lg" placeholder="contoh: Sehat;Obat;"></asp:TextBox>
                      <p style="margin-top:5px;">
                ...
                <div class="col-sm-offset-4 col-sm-4">
                      ...
                      <asp:Button ID="Run" runat="server" Text="LAUNCH" CssClass="btn-primary btn btn-block"  OnClick="Run_Click"/>
                      <br />
                      <br />
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/1.jpg" class="img-responsive img-circle" alt="" style="width:80%;height:auto">
                        <h4>Ari Pratama Zhorifiandi</h4>
                        <p class="text-muted">Programmer</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://twitter.com/arizhopratama"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/arizhopratama"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://plus.google.com/117874164476873286610/"><i class="fa fa-google-plus"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/2.jpg" class="img-responsive img-circle" alt="" style="width:80%;height:auto">
                        <h4>Atika Firdaus</h4>
                        <p class="text-muted">Programmer</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://twitter.com/atikafrds"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/atikafrds"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://plus.google.com/114343977574383325637/"><i class="fa fa-google-plus"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="img/team/3.jpg" class="img-responsive img-circle" alt="" style="width:80%;height:auto">
                        <h4>Anwar Ramadha</h4>
                        <p class="text-muted">Programmer</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://twitter.com/AnwarRamadha"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/anwar.ramadha"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://plus.google.com/100815411808297500579/"><i class="fa fa-google-plus"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- Portfolio Modals -->
    <!-- Use the modals below to showcase details Launch your portfolio projects! -->
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal6" tabindex="-1" role="dialog" aria-hidden="true">
     ...
     <!-- Tweet Modal 6 -->
    <div class="portfolio-modal modal fade" id="Tweet" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
